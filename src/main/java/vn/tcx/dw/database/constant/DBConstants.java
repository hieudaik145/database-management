package vn.tcx.dw.database.constant;
...
public class DBConstants {
    ...
    /**
     * LOB value operations require enabled transactions. I.e. LOB locator life time
     * is 1 transaction.
     */
    public static final String FEATURE_LOB_REQUIRE_TRANSACTIONS = "datasource.lob-require-transactions";
    /**
     * Max string length. Used by data transfer/compare/migration tools. null means
     * "unknown", -1 means any length (i.e. explicit length is not needed)
     */
    ...
    // Internal properties prefix. This is a legacy properties marker (used to
    // divide driver properties from provider properties)
    // Left for backward compatibility. Do not use it for new provider property
    // names
    ...
    public static final String[] DEFAULT_DATATYPE_NAMES = { "varchar", // NON-NLS-1
            "varchar2", // NON-NLS-1
            "string", // NON-NLS-1
            "char", // NON-NLS-1
            "integer", // NON-NLS-1
