...
import vn.tcx.dw.database.constant.JDBCConstants;
...
public class JDBCURL {
    ...
    public static String generateUrlByTemplate(DBPDriver driver, DBPConnectionInfo connectionInfo) {
        String urlTemplate = driver.getSampleURL();
        return JDBCURL.generateUrlByTemplate(urlTemplate, connectionInfo);
    }

    public static String generateUrlByTemplate(String urlTemplate, DBPConnectionInfo connectionInfo) {
